...
//		frame.setContentPane(new JLabel(new ImageIcon(ImageIO.read(new File("bg1.png")))));
		...
		frame1.setBounds(100, 100, 893, 488);
		frame1.setDefaultCloseOperation(frame1.DISPOSE_ON_CLOSE);
		frame1.getContentPane().setLayout(null);
		
		JLabel lblPic = new JLabel("");
		Image img1=new ImageIcon(this.getClass().getResource("/routine.png")).getImage();
		lblPic.setIcon(new ImageIcon(img1));
		lblPic.setBounds(10, -48, 758, 486);
		...
		btnBack.setBounds(778, 415, 89, 23);
